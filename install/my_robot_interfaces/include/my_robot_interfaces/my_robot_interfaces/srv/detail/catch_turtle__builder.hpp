...
class Init_CatchTurtle_Response_message
{
public:
  Init_CatchTurtle_Response_message()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::srv::CatchTurtle_Response message(::my_robot_interfaces::srv::CatchTurtle_Response::_message_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_CatchTurtle_Response_message();
}
