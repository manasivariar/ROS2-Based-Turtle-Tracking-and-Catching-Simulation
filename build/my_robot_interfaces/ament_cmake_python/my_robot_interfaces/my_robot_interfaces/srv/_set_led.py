...
class Metaclass_SetLed_Event(type):
    """Metaclass of message 'SetLed_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_led__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_led__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_led__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_led__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_led__event
...
class SetLed_Event(metaclass=Metaclass_SetLed_Event):
    """Message class 'SetLed_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/SetLed_Request, 1>',
        'response': 'sequence<my_robot_interfaces/SetLed_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'SetLed_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'SetLed_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import SetLed_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetLed_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetLed_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import SetLed_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetLed_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetLed_Response'"
...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_led.Metaclass_SetLed_Event._TYPE_SUPPORT is None:
                _set_led.Metaclass_SetLed_Event.__import_type_support__()
...
class SetLed(metaclass=Metaclass_SetLed):
    ...
    from my_robot_interfaces.srv._set_led import SetLed_Event as Event
