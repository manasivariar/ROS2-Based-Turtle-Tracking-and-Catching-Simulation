...
#include "my_robot_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_c.h"
...
using _Turtle__ros_msg_type = my_robot_interfaces__msg__Turtle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__Turtle * ros_message = static_cast<const my_robot_interfaces__msg__Turtle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__Turtle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__Turtle * ros_message = static_cast<my_robot_interfaces__msg__Turtle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__Turtle(cdr, ros_message);
}

static uint32_t _Turtle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__Turtle(
...
static size_t _Turtle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__msg__Turtle(
...
static message_type_support_callbacks_t __callbacks_Turtle = {
...
static rosidl_message_type_support_t _Turtle__type_support = {
